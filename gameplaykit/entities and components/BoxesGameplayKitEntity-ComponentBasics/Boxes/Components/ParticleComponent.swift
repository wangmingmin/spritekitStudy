...
class ParticleComponent: GKComponent {
    ...
    var geometryComponent: GeometryComponent? {
        return entity?.componentForClass(GeometryComponent.self)
    }
    ...
    */
    ...
    override func updateWithDeltaTime(_: NSTimeInterval) {
        /*
    ...
    */
    func updateGeometryComponent() {
        ...
        */
        if let geometryComponent = geometryComponent where !boxHasParticleEffect {
    ...
    */
    func nextTargetLightBrightness() -> CGFloat {
        ...
        let clampedLightBrightness = (0...1).clamp(newTargetLightBrightness...newTargetLightBrightness).start
